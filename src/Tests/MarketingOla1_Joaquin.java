...
public class MarketingOla1_Joaquin extends TestBase {
	...
	@Test(groups = {"Marketing", "Ola1", "GestionDelSocioDeClubPersonal"}, priority = 2, dataProvider="MarketingCuentaSinServicio")
	...
	@Test(groups = {"Marketing", "Ola1", "GestionDelSocioDeClubPersonal"}, priority = 2, dataProvider="MarketingCuentaConFraude")
	...
	@Test(groups = {"Marketing", "Ola1", "GestionDelSocioDeClubPersonal"}, priority = 4, dataProvider="MarketingCuentaNormal")
	...
	@Test(groups = {"Marketing", "Ola1", "GestionDelSocioDeClubPersonal"}, priority = 11, dataProvider="MarketingCuentaNormal")
	...
	@Test(groups = {"Marketing", "Ola1", "GestionDelSocioDeClubPersonal"}, priority = 10, dataProvider="MarketingCuentaNormal")
