...
public class TestsXappia extends TestBase {
	...
	public void TXS_0006_CRM_Verificar_Pasos_Alta_de_Linea_Cliente_Nuevo_OfCom_StorePickUp(){
		...
		carrito();
		sleep(20000);
		sb.ResolverEntrega(driver, "Store Pick Up", "Ciudad Autï¿½noma de Buenos Aires","CIUD AUTON D BUENOS AIRES");
		sleep(8000);
...
//	}
	...
	@Test (groups = {"SIT","UAT"})
	public void TXSU00027_Modificacion_de_datos_No_Permitir_actualizar_fecha_de_nacimiento_al_colocar_un_año_mayor_a_120_ofcom() {
		irAConsolaFAN();
		sb.cerrarPestaniaGestion(driver);
		cc.menu_360_Ir_A("Inicio");
		irAGestionDeClientes();
	...
	@Test (groups = {"SIT","UAT"})
	public void TXSU00028_Modificacion_de_datos_No_Permitir_actualizar_fecha_de_nacimiento_al_colocar_un_año_menor_a_16_Telefonico() {
		LoguearTelefonico();
		irAConsolaFAN();
		sb.cerrarPestaniaGestion(driver);
		cc.menu_360_Ir_A("Inicio");
